...
def send_password_reset_code_email(*, email: str, code: str) -> None:
    ...
    text_content = (
        f"Olá,\n\n"
        f"Bem-vindo à Extreme Way.\n"
        f"Para redefinir a sua senha, introduz este código:\n\n"
        f"{formatted_code}\n\n"
        f"Se não foste tu, ignora este email.\n"
        f"Obrigado!"
    )
    ...
    <html>
      <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
        <div style="max-width: 640px; margin: 0 auto; background: #ffffff; padding: 24px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.08);">
          <h2 style="color:#222; margin-top: 0;">Redefinição de senha</h2>
          <p style="color:#444; line-height: 1.5;">
            Bem-vindo à <strong>Extreme Way</strong>. Para redefinir a sua senha, introduz o código abaixo:
          </p>
